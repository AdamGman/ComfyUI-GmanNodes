...
_PLANNER_SYSTEM = (
    ...
    "light, weather). Then scenes are ABOUT the world: subjects are landscapes, structures and phenomena; "
    "people may appear in AT MOST one scene in four, only as tiny distant figures for scale — never a "
    "face, never a close or medium shot of a person, and never the same 'group standing and watching' "
    "composition twice.\n"
